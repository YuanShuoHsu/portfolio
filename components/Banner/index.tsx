...
export default function Banner() {
  ...
  return (
    <div className={`${styles.banner} ${nightValue ? styles.night : ""}`}>
      ...
      <div className={styles.banner__buttonGroup}>
        ...
        <button className={styles.banner__button}>
          <svg className={styles.banner__buttonIcon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
          ...
          <span className={styles.banner__buttonText}>{`Let's Chat`}</span>
        </button>
      </div>
      <div>
        <Social />
