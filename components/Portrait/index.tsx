...
export default function Portrait() {
  return (
    <div className={styles.portrait}>
      <ul className={styles.portrait__list}>
        <li
          className={styles.portrait__listItem}
          style={{ "--i": 1 ,"--clr": "#f26524"} as React.CSSProperties}
        >
          <svg
        ...
        <li
          className={styles.portrait__listItem}
          style={{ "--i": 2, "--clr": "#2865F0" } as React.CSSProperties}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 384 512"
        ...
        <li
          className={styles.portrait__listItem}
          style={{ "--i": 3,"--clr": "#f0dc4e"  } as React.CSSProperties}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
        ...
        <li
          className={styles.portrait__listItem}
          style={{ "--i": 4,"--clr": "#61dbfb" } as React.CSSProperties}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
        ...
        <li
          className={styles.portrait__listItem}
          style={{ "--i": 5,"--clr": "#3fba84" } as React.CSSProperties}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
